...
void setWindowSize(int width=750,int height=600)
...
void intro()
{
   ...
   gotoXY(20,15); printf("For my expreance");
...
void menu()
{
    ...
    gotoXY(12,12);
    cout<<"Press s ----> Searcha Record.";
    gotoXY(12, 14);
    cout<<"Press l ----> List The mployee Table.";
    gotoXY(12, 16);
